"""
Django settings for Slack Clone project.
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'A Slack clone backend API with authentication, workspace management, and real-time messaging capabilities.',
    'VERSION': '1.0.0',
    ...
    'TAGS': [
        ...
        {'name': 'Users', 'description': 'User profile management and user listing'},
        {'name': 'Workspaces', 'description': 'Workspace CRUD operations and management'},
        {'name': 'Workspace Members', 'description': 'Member management within workspaces'},
        {'name': 'Workspace Invites', 'description': 'Invitation system for joining workspaces'},
    ],
